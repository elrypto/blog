...
import fs from 'fs';
import { fileToMarkdown } from '../services/Markdown';
        ...
        <div className="flex items-end mt-8 ml-4 space-x-6 text-4xl">
          ...
          <div>
            <a data-for='twitter-icon' data-tip='https://twitter.com/elrypto'>
              <FontAwesomeIcon className="hover:text-cool-gray-400" icon={faTwitter} />
            </a>
            <ReactTooltip id='twitter-icon' className='custom-color-no-arrow' delayHide={500}
              textColor='#5F4B8BFF' backgroundColor='#E69A8DFF' effect='solid' />
          </div>
          <div>
            <a data-for='github-icon' data-tip='https://github.com/lrypto'>
              <FontAwesomeIcon className="hover:text-cool-gray-400" icon={faGithub} />
            </a>
            <ReactTooltip id='github-icon' className='custom-color-no-arrow' delayHide={500}
              textColor='#5F4B8BFF' backgroundColor='#E69A8DFF' effect='solid' />
          </div>
          <div>
            <a data-for='youtube-icon' data-tip='https://www.youtube.com/channel/UC0CFiIg0jhtBRy_U0Rs4gpw'>
              <FontAwesomeIcon className="hover:text-cool-gray-400" icon={faYoutube} />
            </a>
            <ReactTooltip id='youtube-icon' className='custom-color-no-arrow' delayHide={500}
              textColor='#5F4B8BFF' backgroundColor='#E69A8DFF' effect='solid' />
          </div>
          <div>
            <a data-for='email-icon' data-tip='elrypto@gmail.com'>
              <FontAwesomeIcon className="hover:text-cool-gray-400" icon={faMailBulk} />
            </a>
            <ReactTooltip id='email-icon' className='custom-color-no-arrow' delayHide={500}
              textColor='#5F4B8BFF' backgroundColor='#E69A8DFF' effect='solid' />
          </div>
        </div>
        <div className="mx-10 mt-16">
          <span className="text-xl text-gray-500">Modern Application Engineering for Performance and Scale </span>
          <ul>
            <li>React</li>
            <li>nextjs</li>
            <li>Typescript</li>
...
export const getStaticProps = async () => {
  ...
  const postObjs = paths.map(f => (fileToMarkdown(f.params.slug)))
